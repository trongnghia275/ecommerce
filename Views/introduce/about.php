	...
	<div class="container">
		...
		<div class="row text-center">
			<div class="col-sm-12 col-md-4">
				<div class="single-member">
					<div class="member-img">
						<a href="#"><img src="public/img/about/nghia.jpg" alt="Team Member" /></a>
					</div>
					<div class="share-member">
						<div class="member-title">
							<h4>Trần Đỗ Trọng Nghĩa</h4>
						</div>
						<div class="member-btn">	
							<a href="https://www.facebook.com/trongnghia.2705/" target="_blank"><i class="mdi mdi-facebook"></i></a>
			...
			<div class="col-sm-12 col-md-4">
				<div class="single-member">
					<div class="member-img">
						<a href="#"><img src="public/img/about/tan.jpg" alt="Team Member" /></a>
					</div>
					<div class="share-member">
						<div class="member-title">
							<h4>Lê Quốc Tấn</h4>
						...
						<div class="member-btn">	
							<a href="https://www.facebook.com/lequoc.tan.96" target="_blank"><i class="mdi mdi-facebook"></i></a>
							<a href="#"><i class="mdi mdi-twitter"></i></a>
							<a href="#"><i class="mdi mdi-google-plus"></i></a>
							<a href="#"><i class="mdi mdi-dribbble"></i></a>
							<a href="#"><i class="mdi mdi-rss"></i></a>
